...
<link rel="stylesheet" href="https://use.typekit.net/zhy3zvm.css">

<!--  <link href="${baseUrl}/template-resources/assets/external/fontawesome/css/all.css" rel="stylesheet">--->
...
<!--  <script defer src="${baseUrl}/template-resources/assets/external/fontawesome/js/all.js"></script> --><!--load all styles -->
