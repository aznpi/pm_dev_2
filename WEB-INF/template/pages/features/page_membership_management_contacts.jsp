						 ...
						 <div class="collapse navbar-collapse" id="navbarNav-2">
						    <ul class="navbar-nav">
						      <li class="nav-item active">
						      	<a class="nav-link" href="${baseUrl}/feature/membership-management/contacts-accounts">Contacts and Accounts<span class="sr-only">(current)</span></a>
						      </li>
						      <li class="nav-item">
						      	<a class="nav-link" href="${baseUrl}/feature/membership-management/membership">Membership</a>
						      </li>
						      <li class="nav-item">
						      	<a class="nav-link" href="${baseUrl}/feature/membership-management/staff-management">Staff Management</a>
						      </li>
						       <li class="nav-item">
						        <a class="nav-link" href="${baseUrl}/feature/membership-management/document-management">Document Management</a>
						      </li>
						    </ul>
						 </div>
						</nav>	
